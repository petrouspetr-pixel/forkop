export const TRAFIRA_UCI_PACKAGE = 'trafira';
export const TRAFIRA_LUCI_APP_VERSION = '__COMPILED_VERSION_VARIABLE__';
export const TRAFIRA_ACTION_PROVIDERS_AVAILABILITY_EVENT =
