...
interface IRenderSectionsProps {
  ...
  onCopyOutbound: (
    section: Trafira.OutboundGroup,
    outbound: Trafira.Outbound,
  ) => void;
  onShowUrlTestInfo: (outbound: Trafira.Outbound) => void;
  onShowPriorityInfo: (outbound: Trafira.Outbound) => void;
  onUpdateSubscription: (section: Trafira.OutboundGroup) => void;
  latencyFetching: boolean;
  latencyProgress?: Trafira.LatencyActionProgress;
...
function renderSubscriptionMetadata(
  metadata: Trafira.SubscriptionMetadata | undefined,
) {
...
function renderDefaultState({
  ...
  function renderOutbound(outbound: Trafira.Outbound) {
