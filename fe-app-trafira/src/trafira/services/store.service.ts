...
export interface StoreType {
  ...
  servicesInfoWidget: {
    ...
    data: {
      singbox: number;
      trafiraRunning: number;
      trafiraEnabled: number;
  ...
  sectionsWidget: {
    ...
    latencyProgressSections: Record<string, Trafira.LatencyActionProgress>;
  ...
  updatesActions: {
    trafiraCheck: { loading: boolean };
    trafiraInstall: { loading: boolean };
