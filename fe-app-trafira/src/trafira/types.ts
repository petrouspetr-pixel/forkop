...
// eslint-disable-next-line @typescript-eslint/no-namespace
export namespace Trafira {
  // Available commands:
  // start                   Start trafira service
  // stop                    Stop trafira service
  // reload                  Reload trafira configuration
  // restart                 Restart trafira service
  // enable                  Enable trafira autostart
  // disable                 Disable trafira autostart
  // uninstall               Remove trafira files installed outside opkg/apk
  // main                    Run main trafira process
  ...
  // check_logs              Show trafira logs from system journal
  ...
  // show_config             Display current trafira configuration
  // show_version            Show trafira version
  // show_sing_box_config    Show sing-box configuration
  // show_sing_box_version   Show sing-box version
  // get_status              Get trafira service status
  ...
  export interface GetSystemInfo {
    trafira_version: string;
    trafira_latest_version: string;
