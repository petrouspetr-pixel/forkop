...
const syncDirs = [
  {
    local: path.resolve(
      process.env.LOCAL_DIR_FE ??
        '../luci-app-trafira/htdocs/luci-static/resources/view/trafira',
    ),
    remote:
      process.env.REMOTE_DIR_FE ?? '/www/luci-static/resources/view/trafira',
  },
  {
    local: path.resolve(
      process.env.LOCAL_DIR_BIN ?? '../trafira/files/usr/bin/',
    ),
    remote: process.env.REMOTE_DIR_BIN ?? '/usr/bin/',
  },
  {
    local: path.resolve(
      process.env.LOCAL_DIR_LIB ?? '../trafira/files/usr/lib/',
    ),
    remote: process.env.REMOTE_DIR_LIB ?? '/usr/lib/trafira/',
  },
  {
    local: path.resolve(
      process.env.LOCAL_DIR_INIT ?? '../trafira/files/etc/init.d/',
    ),
