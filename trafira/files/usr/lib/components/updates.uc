...
const BIN_PATH = getenv("TRAFIRA_BIN") || "/usr/bin/trafira";
...
const RUNTIME_CACHE_FORMAT = getenv("TRAFIRA_RUNTIME_CACHE_FORMAT") || "8";
...
const RELOAD_STATE_FORMAT = getenv("TRAFIRA_RELOAD_STATE_FORMAT") || "1";
...
const SERVICE_INIT = getenv("TRAFIRA_SERVICE_INIT") || "/etc/init.d/trafira";
const PRIORITY_UC = getenv("TRAFIRA_PRIORITY_UC") || LIB_DIR + "/singbox/priority.uc";
const DNS_FAILOVER_UC = getenv("TRAFIRA_DNS_FAILOVER_UC") || LIB_DIR + "/singbox/dns_failover.uc";
const COMPONENT_JOB_DIR = getenv("UPDATES_JOB_DIR") || getenv("TRAFIRA_UI_COMPONENT_ACTION_DIR") || "/var/run/trafira/component-actions";
const COMPONENT_UPDATE_CHECK_CACHE_DIR = getenv("TRAFIRA_COMPONENT_UPDATE_CHECK_CACHE_DIR") || RUNTIME_STATE_DIR + "/component-update-checks";
const COMPONENT_UPDATE_CHECK_STATE_FILE = getenv("TRAFIRA_COMPONENT_UPDATE_CHECK_STATE_FILE") || RUNTIME_STATE_DIR + "/component-update-check.timestamp";
const COMPONENT_UPDATE_CHECK_LOCK_DIR = getenv("TRAFIRA_COMPONENT_UPDATE_CHECK_LOCK_DIR") || RUNTIME_STATE_DIR + "/component-update-check.lock";
...
const COMPONENT_JOB_STALE_GRACE_SECONDS = getenv("UPDATES_JOB_STALE_GRACE_SECONDS") || getenv("TRAFIRA_UI_ACTION_STALE_GRACE_SECONDS") || "15";
const SUBSCRIPTION_JOB_FINISHED_TTL_MINUTES = getenv("TRAFIRA_SUBSCRIPTION_UPDATE_JOB_FINISHED_TTL_MINUTES") || "60";
const SUBSCRIPTION_JOB_ORPHAN_OUTPUT_TTL_MINUTES = getenv("TRAFIRA_SUBSCRIPTION_UPDATE_JOB_ORPHAN_OUTPUT_TTL_MINUTES") || "60";
const SUBSCRIPTION_JOB_STALE_GRACE_SECONDS = getenv("TRAFIRA_UI_ACTION_STALE_GRACE_SECONDS") || "15";
const NFT_TABLE_NAME = getenv("NFT_TABLE_NAME") || "TrafiraTable";
const NFT_COMMON_SET_NAME = getenv("NFT_COMMON_SET_NAME") || "trafira_subnets";
const NFT_COMMON6_SET_NAME = getenv("NFT_COMMON6_SET_NAME") || "trafira_subnets6";
const NFT_IP_PORT_SET_NAME = getenv("NFT_IP_PORT_SET_NAME") || "trafira_ip_ports";
const NFT_IP_PORT6_SET_NAME = getenv("NFT_IP_PORT6_SET_NAME") || "trafira_ip6_ports";
const NFT_DISCORD_SET_NAME = getenv("NFT_DISCORD_SET_NAME") || "trafira_discord_subnets";
const NFT_DISCORD6_SET_NAME = getenv("NFT_DISCORD6_SET_NAME") || "trafira_discord_subnets6";
const NFT_INTERFACE_SET_NAME = getenv("NFT_INTERFACE_SET_NAME") || "trafira_interfaces";
...
function ensure_subscription_runtime_dirs() {
    let command = command_env({
        ...
        TRAFIRA_RUNTIME_CACHE_FORMAT: RUNTIME_CACHE_FORMAT,
...
function subscription_worker_env() {
    return {
        ...
        TRAFIRA_RUNTIME_STATE_DIR: RUNTIME_STATE_DIR,
        TRAFIRA_SUBSCRIPTION_UPDATE_STATE_DIR: SUBSCRIPTION_UPDATE_STATE_DIR,
        TRAFIRA_SUBSCRIPTION_UPDATE_JOB_DIR: SUBSCRIPTION_JOB_DIR,
        TRAFIRA_SUBSCRIPTION_LINKS_DIR: SUBSCRIPTION_LINKS_DIR,
        TRAFIRA_SUBSCRIPTION_METADATA_DIR: SUBSCRIPTION_METADATA_DIR,
        TRAFIRA_OUTBOUND_METADATA_DIR: OUTBOUND_METADATA_DIR,
        TRAFIRA_SECTION_CACHE_DIR: SECTION_CACHE_DIR,
        ...
        TRAFIRA_PERSISTENT_SUBSCRIPTION_CACHE_FORMAT_FILE: PERSISTENT_SUBSCRIPTION_CACHE_FORMAT_FILE,
        TRAFIRA_PERSISTENT_SUBSCRIPTION_CACHE_FORMAT: PERSISTENT_SUBSCRIPTION_CACHE_FORMAT,
        TRAFIRA_SUBSCRIPTION_UPDATE_JOB_FINISHED_TTL_MINUTES: SUBSCRIPTION_JOB_FINISHED_TTL_MINUTES,
        TRAFIRA_SUBSCRIPTION_UPDATE_JOB_ORPHAN_OUTPUT_TTL_MINUTES: SUBSCRIPTION_JOB_ORPHAN_OUTPUT_TTL_MINUTES,
        TRAFIRA_UI_ACTION_STALE_GRACE_SECONDS: SUBSCRIPTION_JOB_STALE_GRACE_SECONDS
    };
}
...
function component_worker_env() {
    return {
        ...
        TRAFIRA_UI_COMPONENT_ACTION_TRACKED: "1"
    };
}
...
function subscription_update_common(force, target_section, target_source_index) {
    ...
    if (!acquire_runtime_lock(RELOAD_LOCK_DIR, force)) {
        ...
        log_message("Trafira reload is already running; skipping subscription update", "info");
        if (force)
