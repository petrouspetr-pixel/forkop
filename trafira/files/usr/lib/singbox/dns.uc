...
const DNS_FAILOVER_STATE_FILE = getenv("TRAFIRA_DNS_FAILOVER_STATE_FILE") || "/var/run/trafira/dns-failover.json";
const DNS_HEALTH_ADDRESS = getenv("TRAFIRA_DNS_HEALTH_ADDRESS") || "127.0.0.42";
const DNS_HEALTH_PORT_BASE = int(getenv("TRAFIRA_DNS_HEALTH_PORT_BASE") || "10053");
