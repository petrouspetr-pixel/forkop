...
const NFT_PORT_SET_NAME = getenv("NFT_PORT_SET_NAME") || "trafira_ports";
...
const SB_MANAGED_SERVICE_MARKER = getenv("SB_MANAGED_SERVICE_MARKER") || "Trafira managed sing-box service for binary variants";
...
function service_listen_address_value(settings) {
    ...
    log_message("Failed to determine the listening IP address. Please open an issue to report this problem: https://github.com/petrouspetr-pixel/trafira/issues", "error");
    return "";
}
