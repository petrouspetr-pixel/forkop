...
const PRIORITY_PID_FILE = getenv("TRAFIRA_PRIORITY_PID_FILE") || RUNTIME_STATE_DIR + "/priority.pid";
const PRIORITY_UC = getenv("TRAFIRA_PRIORITY_UC") || LIB_DIR + "/singbox/priority.uc";
const DIAGNOSTICS_UC = getenv("TRAFIRA_DIAGNOSTICS_UC") || LIB_DIR + "/diagnostics/runtime.uc";
...
function log_message(message, level) {
    ...
    command_success_from_args([ "logger", "-t", "trafira", "[" + level + "] priority: " + as_string(message) ]);
}
