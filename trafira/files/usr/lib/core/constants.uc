...
function constants_map() {
    ...
    c.TRAFIRA_VERSION = env("TRAFIRA_VERSION", "__COMPILED_VERSION_VARIABLE__");
    c.TRAFIRA_CONFIG_NAME = env("TRAFIRA_CONFIG_NAME", "trafira");
    c.TRAFIRA_CONFIG = env("TRAFIRA_CONFIG", "/etc/config/" + c.TRAFIRA_CONFIG_NAME);
    c.TRAFIRA_BIN = env("TRAFIRA_BIN", "/usr/bin/trafira");
    c.TRAFIRA_SERVICE_NAME = env("TRAFIRA_SERVICE_NAME", "trafira");
    c.TRAFIRA_SERVICE_INIT = env("TRAFIRA_SERVICE_INIT", "/etc/init.d/trafira");
    c.TRAFIRA_RELEASE_REPO = env("TRAFIRA_RELEASE_REPO", "petrouspetr-pixel/trafira");
    c.TRAFIRA_LUCI_VIEW_NAMESPACE = env("TRAFIRA_LUCI_VIEW_NAMESPACE", "trafira");
    c.TRAFIRA_LUCI_VIEW_DIR = env("TRAFIRA_LUCI_VIEW_DIR", "/www/luci-static/resources/view/" + c.TRAFIRA_LUCI_VIEW_NAMESPACE);
    c.TRAFIRA_LUCI_I18N_DOMAIN = env("TRAFIRA_LUCI_I18N_DOMAIN", "trafira");
    ...
    c.RT_TABLE_NAME = env("RT_TABLE_NAME", "trafira");

    c.NFT_TABLE_NAME = env("NFT_TABLE_NAME", "TrafiraTable");
    c.NFT_LOCALV4_SET_NAME = env("NFT_LOCALV4_SET_NAME", "localv4");
    c.NFT_LOCALV6_SET_NAME = env("NFT_LOCALV6_SET_NAME", "localv6");
    c.NFT_COMMON_SET_NAME = env("NFT_COMMON_SET_NAME", "trafira_subnets");
    c.NFT_COMMON6_SET_NAME = env("NFT_COMMON6_SET_NAME", "trafira_subnets6");
    c.NFT_PORT_SET_NAME = env("NFT_PORT_SET_NAME", "trafira_ports");
    c.NFT_IP_PORT_SET_NAME = env("NFT_IP_PORT_SET_NAME", "trafira_ip_ports");
    c.NFT_IP_PORT6_SET_NAME = env("NFT_IP_PORT6_SET_NAME", "trafira_ip6_ports");
    c.NFT_DISCORD_SET_NAME = env("NFT_DISCORD_SET_NAME", "trafira_discord_subnets");
    c.NFT_DISCORD6_SET_NAME = env("NFT_DISCORD6_SET_NAME", "trafira_discord_subnets6");
    c.NFT_INTERFACE_SET_NAME = env("NFT_INTERFACE_SET_NAME", "trafira_interfaces");
    ...
    c.SB_MANAGED_SERVICE_MARKER = env("SB_MANAGED_SERVICE_MARKER", "Trafira managed sing-box service for binary variants");
    ...
    c.SB_VARIANT_STATE_FILE = env("SB_VARIANT_STATE_FILE", "/etc/trafira/sing-box-variant");
    c.SB_VERSION_STATE_FILE = env("SB_VERSION_STATE_FILE", "/etc/trafira/sing-box-version");
    ...
    c.ZAPRET_LEGACY_RUNTIME_BASE_DIR = env("ZAPRET_LEGACY_RUNTIME_BASE_DIR", "/var/run/trafira/zapret-runtime");
    c.ZAPRET_NFQWS_BIN = env("ZAPRET_NFQWS_BIN", c.ZAPRET_PROVIDER_NFQWS_BIN);
    c.ZAPRET_STATE_DIR = env("ZAPRET_STATE_DIR", "/var/run/trafira/zapret");
    ...
    c.ZAPRET2_STATE_DIR = env("ZAPRET2_STATE_DIR", "/var/run/trafira/zapret2");
    ...
    c.BYEDPI_STATE_DIR = env("BYEDPI_STATE_DIR", "/var/run/trafira/byedpi");
