...
function subscription_cache_paths(section) {
    return [
        ...
        TRAFIRA_SUBSCRIPTION_METADATA_DIR + "/" + section + ".json",
        TRAFIRA_SUBSCRIPTION_LINKS_DIR + "/" + section + ".json",
        TRAFIRA_OUTBOUND_METADATA_DIR + "/" + section + ".json",
        TRAFIRA_SECTION_CACHE_DIR + "/" + section + ".json",
...
// Podkop Plus -> Trafira source migration.
...
function main(argv) {
    ...
    warn("       config/migration.uc migrate-fixture <fixture.json> [trafira|podkop]\n");
    return 1;
}
