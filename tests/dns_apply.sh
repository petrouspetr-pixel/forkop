...
APPLY="$ROOT_DIR/trafira/files/usr/lib/dns/apply.uc"
...
trafira.settings.shutdown_correctly=1
EOF_STATE
...
assert_value 'dhcp.@dnsmasq[0].trafira_server' '1.1.1.1 8.8.8.8'
assert_value 'dhcp.@dnsmasq[0].noresolv' '1'
assert_value 'dhcp.@dnsmasq[0].trafira_noresolv' '0'
assert_value 'dhcp.@dnsmasq[0].cachesize' '0'
assert_value 'dhcp.@dnsmasq[0].trafira_cachesize' '150'
...
assert_absent 'dhcp.@dnsmasq[0].trafira_server'
assert_absent 'dhcp.@dnsmasq[0].trafira_noresolv'
...
dhcp.@dnsmasq[0].trafira_server=1.1.1.1 8.8.8.8
dhcp.@dnsmasq[0].trafira_notinterface=wan docker
dhcp.@dnsmasq[0].trafira_noresolv=1
dhcp.@dnsmasq[0].trafira_cachesize=0
dhcp.trafira.interface=br-lan guest
...
assert_value 'dhcp.@dnsmasq[0].cachesize' '0'
assert_absent 'dhcp.@dnsmasq[0].trafira_server'
assert_absent 'dhcp.@dnsmasq[0].trafira_notinterface'
assert_absent 'dhcp.@dnsmasq[0].trafira_noresolv'
assert_absent 'dhcp.@dnsmasq[0].trafira_cachesize'
assert_absent 'dhcp.trafira.interface'
assert_log_contains 'commit dhcp'
